...
export const Footer = () => {
  return (
    <footer className="bg-mint text-foreground py-8 md:py-12">
      <div className="container mx-auto px-4">
        <div className="flex flex-col gap-6 md:gap-8">
          ...
          <div className="flex flex-col items-center gap-6">
            ...
            >
              <div className="w-9 h-9 md:w-10 md:h-10 rounded-lg md:rounded-xl bg-gradient-to-br from-orange to-orange-light flex items-center justify-center">
                <span className="text-primary-foreground font-heading font-black text-base md:text-lg">BF</span>
              </div>
              <div>
                <span className="font-heading font-bold text-base md:text-lg text-foreground">Big Fitness</span>
              </div>
            </motion.div>

            {/* App download buttons */}
            <div className="flex flex-wrap items-center justify-center gap-2 md:gap-4">
              <span className="text-foreground/60 flex items-center gap-1.5 md:gap-2 text-xs md:text-sm">
              ...
              >
                ...
                <span className="text-[10px] md:text-xs font-medium">Google Play</span>
              </a>
            </div>
          ...
          <div className="flex flex-col items-center gap-3 md:gap-4">
            ...
            {/* Copyright */}
            <div className="flex items-center gap-2 text-foreground/60 text-xs md:text-sm">
