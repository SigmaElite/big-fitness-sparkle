        ...
        <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-center">
          ...
          >
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 bg-card/80 backdrop-blur-sm rounded-full px-3 py-1.5 shadow-soft mb-4"
            >
              <Sparkles className="w-3 h-3 text-primary" />
              <span className="text-xs font-semibold text-foreground">Новая Боровая</span>
            </motion.div>
            ...
            <motion.h1
              ...
              className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-heading font-black leading-tight mb-3"
            >
            ...
            <motion.div
              ...
              className="bg-mint/50 backdrop-blur-sm rounded-xl p-3 mb-4 border-2 border-primary/30"
            >
              <div className="flex items-start gap-2">
                ...
                <div>
                  <p className="font-bold text-foreground text-sm">Занимайтесь одновременно с ребёнком!</p>
                  <p className="text-xs text-muted-foreground">Ребёнок занимается в одном зале, вы — в другом</p>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="bg-card/80 backdrop-blur-sm rounded-xl p-3 mb-4 border-2 border-primary/20"
            >
              <div className="flex items-center gap-2 mb-2">
                ...
                <div>
                  <p className="font-bold text-foreground text-sm">Запись через приложение Big Fitness</p>
                  <p className="text-xs text-muted-foreground">Скачайте и записывайтесь онлайн</p>
                </div>
              </div>
              <div className="flex gap-2">
                <a
                  ...
                  className="flex items-center gap-1.5 bg-foreground text-card px-3 py-2 rounded-lg hover:bg-foreground/90 transition-colors flex-1 justify-center"
                >
            ...
            >
              <Button variant="hero" size="lg" className="group w-full sm:w-auto text-sm">
            ...
            >
              {[
                ...
                { icon: ShowerHead, value: "3", label: "раздевалки" },
              ].map((stat, index) => (
                <motion.div
                  key={stat.label}
                ...
                >
                  <div className="inline-flex items-center justify-center w-9 h-9 rounded-xl bg-mint mb-1">
          ...
          >
            <motion.div
              className="relative z-10 rounded-3xl overflow-hidden shadow-2xl max-w-md mx-auto"
