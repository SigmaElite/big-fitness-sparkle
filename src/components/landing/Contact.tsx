...
export const Contact = () => {
  ...
  return (
    <section id="contacts" className="py-10 md:py-20 bg-gradient-to-br from-mint-light via-card to-mint-light relative overflow-x-hidden w-full max-w-full" ref={ref}>
